...
export default class Chart extends React.Component {
    ...
    buildDataTableFromProps ()
    {
        ...
        {
            if ( this.props.data === null && this.props.columns.length === 0 )
            {
    ...
    render ()
    {
        ...
        return <div id={this.state.graphID}
                    style={divStyle}> Rendering Chart... </div>
    }
};
